...
import { caffeineStatus, CAFFEINE_HALF_LIFE_HOURS, NEGLIGIBLE_MG } from './caffeine'
...
describe('caffeineStatus', () => {
  ...
  it('reports zero for an empty day and for a fully decayed one', () => {
    expect(caffeineStatus([], NOW)).toEqual({ totalMg: 0, currentMg: 0, hoursUntilNegligible: 0 })
